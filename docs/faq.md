...
- пока рассматривают вашу заявку на ВНЖ можете работать и находиться в Польше. У вас будет специальный штамп в паспорте. Но жить только в Польше если виза закончилась: выезжать нельзя - не пустят назад

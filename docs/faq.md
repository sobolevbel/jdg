...
Члены семьи, при подаче по JDG, подаются по "иным обстоятельствам". Право на работу будет, не будет свободного доступа к рынку труда. То 
есть, нужно будет освядчение или зезволение на работу. То есть, если найдете работу - не обязательно переподаваться на внж по работе.

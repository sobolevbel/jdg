...
- пока рассматривают вашу заявку на ВНЖ можете работать и находиться в Польше. У вас будет специальный штамп в паспорте. Если виза закончилась, то выезжать за территорию Польши нельзя - не пустят назад
...
Далее нужно правильно провести эту покупку и списать VAT. Я отдаю фактуру бухгалтеру и точно не знаю как она это делает.

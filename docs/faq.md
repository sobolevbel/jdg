---
title: FAQ — часто задаваемые вопросы по JDG
description: Ответы на частые вопросы по JDG в Польше — Blue Card, ВНЖ, налоги, смена заказчика, приостановка деятельности, ликвидация ИП
tags:
  - Справочник
  - JDG
  - Легализация
...
- 62.01.12.0 – Usługi związane z projektowaniem i rozwojem technologii informatycznych dla sieci i systemów komputerowych (m.in. analiza systemów klienta, projektowanie i wdrażanie infrastruktury w chmurze, konfiguracja narzędzi monitorujących, automatyzacja wdrożeń)
...
- налог 12% вне зависимости от суммы
- оплата ZUS (цифры 2026 года): на старте ~500 злотых в месяц (только медстраховка), затем ~900–1300 на [складках преференцийных](zus_obnizone_skladki.md), а после 2.5 лет — [полный ZUS](zus_duzy.md) от ~2300 в месяц
- желателен бухгалтер
...
- налог 6% до 240 000 злотых, затем сильно больше. Не выгодно если у вас реально большая зарплата (ок 28к злотых в месяц)
...
Процесс списания VAT В infakt описан в [разделе об отправке декларации VAT (JPK_V7M)][14].

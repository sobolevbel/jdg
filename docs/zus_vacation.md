...
В 2024 году «ZUS-каникулами» можно будет воспользоваться только в декабре, и для этого заявку на освобождение от уплаты взносов необходимо подавать строго **с 1 по 30 ноября 2024 года**.
Мы не рекомендуем откладывать это дело на последний день. Подать заявку можно только **онлайн** через портал PUE ZUS / eZUS.
...
### Шаг 4 из 9. Указание использования помощи de minimis
...
> - За прошедшие 3 года:
>     - [x] я не использовал государственную помощь de minimis
...
Достаточно ввести NIP и нажать кнопку Pobierz nazwę - с вероятностью близкой к 100% вы увидите ошибку "Nie znaleziono podmiotu z takim NIP-em w bazie beneficjentów pomocy".

### Шаг 5 из 9. Категории предпринимателей
...
### Шаг 6 из 9. Связи с другими предпринимателями
...
### Шаг 7 из 9. Информация о возникновении субъекта
...
### Шаг 8 из 9. Информация про определенные категории деятельности
...
### Шаг 9 из 9. Подпись и отправка

![Sign and send][13]

Если на шаге 4 вы выбрали пункт «korzystałem z pomocy publicznej de minimis» + пункт «zaświadczenia», то сейчас, на последнем шаге перед отправкой заявления, вам необходимо приложить справки (zaświadczenia) кнопкой «Dodaj załączniki...»

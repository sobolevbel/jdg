...
Предприниматель должен подать следующие документы:

- **ZUS DRA**: декларация по взносам за себя с учётом "каникул".
- **ZUS RCA**: декларация по взносам, если у предпринимателя есть наёмные работники или подрядчики. На них не распространяется льгота.

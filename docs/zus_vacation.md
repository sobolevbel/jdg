...
Выскочит информация про расчет размера ставки и квоты налога по предоставленным данным.
Нажимаем Ok.
...
Часть налога, оплачиваемая государством, будет указана в декларации с кодом 057400.
...
В декларации с кодом 057000 в соответственных полях будет указана ставка и квота налога.

---
title: Рабочий процесс ИП — ежемесячные обязанности
description: Что делать каждый месяц как JDG — выставление фактуры, оплата налогов, ZUS DRA, JPK. Сроки и порядок действий
tags:
  - Бухгалтерия
  - JDG
  - Декларации
...
!!! abstract "Налоги платятся каждый месяц"
    ...
    !!! abstract "ZUS"
        Оплата ZUS и отправка [ZUS DRA][1] до 20 числа каждого месяца
...
!!! success "Не хотите делать это каждый месяц сами"
    Всю рутину — фактуры, декларации, оплаты — можно отдать
    русскоязычному [бухгалтеру под ключ](accounting.md) от партнёра
    гайда, от 225 zł/мес.
...
4. Оплачиваете все необходимые налоги и сохраняете чеки
    - podatek dochodowy
    - ZUS
    - VAT: при необходимости и возможности вычитаем VAT с покупок из общего VAT. Детальнее — в [разделе FAQ про VAT][2]

Более детальное описание конкретных операций на примере сервиса `infakt.pl` можно найти в [гайде по рутине в infakt][3].

## Учет курсовых разниц

1. [Статья от inFakt][4]
2. [Статья от Poradnik Przedsiębiorcy][5]
3. [Гайд как учесть КР в inFakt][6]

Для JDG курсовые разницы появляются в двух случаях:

1. [Transakcyjne różnice kursowe][7]
2. [Różnice kursowe od środków własnych][8]
...
Курс считается по [Narodowy Bank Polski][9]

## Подача декларации VAT-UE

Подача e-декларации VAT-UE происходит на сайте налоговой с помощью [интерактивной PDF-формы][10]

- Сперва нужно установить Adobe Reader и расширение к нему со [страницы плагина e-Deklaracje][11].
...
- у некоторых ИП может быть ещё [ewidencję środków][12] trwałych (здания, автомобили, устройства и др. вещи, такие, например, как дорогой ноутбук на фирму). [Подробнее об ewidencji środków trwałych][13].

- у некоторых ewidencja przebiegu pojazdów (для автомобиля, записанного на фирму).

- кроме того, ещё одна большая группа документов, которые нужно хранить - это декларации и отчёты отправляемые в ZUS. У вас скорее всего будут ZUS ZZA, ZUS ZUA, ZUS ZCNA, ежемесячная ZUS DRA, а за месяц "каникул" ещё и [ZUS RCA][14]. Не полагайтесь на сайт ZUS. В чате писали, что с него не получилось скачать документы двухлетней давности.
...
[1]: declarations.md#zus-dra
[2]: faq.md#vat
[3]: infakt_routine.md
[4]: https://www.infakt.pl/blog/jak-zaksiegowac-roznice-kursowe
[5]: https://poradnikprzedsiebiorcy.pl/-ryczalt-a-roznice-kursowe
...
[14]: zus_vacation.md#ezhemesiachnye-otchety-vo-vremia-zus-kanikul

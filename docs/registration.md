...
##### Внимание! Пропускайте шаг выбора налоговой системы только в том случае, если Вы точно знаете, что делаете! Если Вы забудете сделать выбор, по умолчанию будет считаться, что выбрана общая система (Skala podatkowa). Поменять выбор можно будет только с начала следующего года.

...
#### 8a. e-Doręczenia - электронная доставка
> e-Doręczenia - это электронный эквивалент заказного письма с подтверждением получения. Благодаря этой услуге государственные учреждения, граждане и компании могут воспользоваться удобными и безопасными электронными поставками. Они юридически эквивалентны традиционной заказной почте с уведомлением о вручении.

Можно переписываться с ужондами. Подробнее можно почитать по [ссылке](https://www.gov.pl/web/e-doreczenia)

Вам предлагают зарегистрировать электронную доставку. Скорее всего у вас ещё нет такого адреса, поэтому выбираем первый пункт - хочу подать данные для создания адреса e-Doręczenia.
![Adres do e-Doręczeń][75]

Система покажет данные пользователя которые вы уже ввели ранее, осталось только ввести адрес электронной почты, на который будут приходить уведомления.

![Adres e-mail do kontaktu][76]

Если хотите что бы к адресу e-Doręczeń имел доступ другой человек (администратор), то добавляем. Права у него такие же как и у собственника. Его можно будет позже удалить.

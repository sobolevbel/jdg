...
Выбираем куда будет приходить бумажная почта от ZUS, опционально указываем имэйл и телефон для связи:
...
[по ссылке](registration.md#12-vat-ue). Если не нужно - отказывайтесь и переходите к следующему пункту.

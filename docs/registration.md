...
⚠️ Обратите внимание, что с момента регистрации VAT плательщиком вы обязаны выставлять польским заказчикам
...
|  podatnik rezygnuje (zrezygnował) ze zwolnienia, o którym mowa w art. 113 ust. 1 lub 9 ustawy                             | ИП добровольно отказывается от освобождения по доходу. (если достигнете порога дохода в 200 000 злотых / добровольная регистрация)                                                                                      |
|  podatnik traci (utracił) zwolnienie, o którym mowa w art. 113 ust. 1 lub 9 ustawy                                        | ИП утратил право на освобождение по доходу. (например, превысил лимит 200 000 zł).                                                                                                                                             |
...
> мы не приводим порядковые номера, т.к. они меняются, читайте описание внимательно и выбирайте.
...
>  **Oświadczenie**
>
>Ja, niżej podpisany, oświadczam, że od dnia **DD.MM.YYYY** prowadzę działalność gospodarczą i wykonuję usługi związane
> z:
>
> **Тут кратко описываем род своей деятельности, 1-3 предложения в свободной форме.**
>
>Do wykonywania działalności dysponuję laptopem z zainstalowanymi pakietami niezbędnych programów komputerowych (*MS
Office, Skype, Zoom, Jira, Figma, Outlook, Chrome* itp.).
>
...
подразделений [министерства финансов](https://www.gov.pl/web/kas/dane-teleadresowe-jednostek-kas), скачав

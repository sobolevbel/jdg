...
Здесь вы указать адрес арендной квартиры скорее всего не хотите.
У кого такой адрес есть (реальный или виртуальный офис), его и указывайте.
...
![Adres zamieldowania][25]

Нажимаем на DALEJ

#### 17. Адрес для корреспонденции

Выбираем куда будет приходит бумажная почта от ZUS, опционально указываем имэйл и телефон для связи:
...
Можно сразу выбрать [систему налогообложения](taxes.md#pit-), нам, конечно, надо:
...
Собственно выбираем [систему налогообложения](taxes.md#pit-):
...
Если вы выбрали систему налогообложения ryczałt - то можете выбрать упрощщенный документооборот:
...
Нам надо только отредактировать данные. Дата может быть текущей, в прошлом, либо в будущем.
...
czynnym плательщиком мы не станем.
...
В случае если ваш код деятельности не подлежит освобождению от VAT (к примеру 62.02.Z) то нужно выбирать пункт `36. Podatnik nie ma prawa do zwolnienia`.
...
[по ссылке](registration.md#12-). Если не нужно - отказывайтесь и переходите к следующему пункту.
...
Дальше как обычно подписываем внесек профилем зауфаны, отправляем и ждем
...
Если вы ещё не были зарегистрированны, то хотите зарегистрироваться плательщиком VAT.
...
зарегистрированы как czynny плательщик польского VAT - то продолжайте [по ссылке](registration.md#5_1).
...
Для покупки чего-либо, вроде бы, не обязательно быть зарегистрированным. Поэтому если на данный момент точно знаете, что не собираетесь продавать товары на экспорт, то можно одним чек-боксом и ограничится.

...
Можно сразу выбрать [систему налогообложения](taxes.md#pit-podokhodnyi-nalog), нам, конечно, надо:
...
и превысили годовой лимит в 200_000 злотых. Либо вы хотите возвращать VAT c покупок на фирму. **Если вы не превысили годовой лимит в 200_000 злотых, тогда не нужно регистрироваться как плательщик VAT иначе вы будете обязаны выставлять фактуры с VAT и уплачивать VAT с начала регистрации как плательщика VAT**.

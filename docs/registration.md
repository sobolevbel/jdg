...
Можно сразу выбрать [систему налогообложения](taxes.md#pit-подоходный-налог), нам, конечно, надо:
...
Собственно выбираем [систему налогообложения](taxes.md#pit-подоходный-налог):
...
[по ссылке](registration.md#12-регистрация-vat-ue). Если не нужно - отказывайтесь и переходите к следующему пункту.
...
зарегистрированы как czynny плательщик польского VAT - то продолжайте [по ссылке](registration.md#5-отказываемся-от-освобождения).

...
Прикладываем сканы паспорта и визы(учитывайте размер файлов, иначе будут проблемы с подписанием заявления), выбираем чек-бокс, что вам можно иметь ИП на территории Польши:

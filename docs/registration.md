...
Дата начала VAT обязательств должная быть, как минимум, на 1 день позже даты подачи заявления. Например, если заявление высылается 28 апреля, то самая ранняя дата регистрации — 29 апреля.
...
Дата регистрации VAT должная быть как минимум на 1 день позже даты подачи заявления.

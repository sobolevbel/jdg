---
title: Легализация по JDG — карта побыту
description: Как получить karta pobytu (ВНЖ) на основании JDG в Польше — список документов, процесс подачи, воссоединение семьи, сроки рассмотрения
tags:
  - Легализация
  - Документы
  - JDG
...
!!! info "Для граждан Украины с PESEL UKR"
    К гражданам Украины со статусом UKR, которые ведут JDG по записи в CEIDG,
    ужонд не применяет требование art. 142 ust. 1 pkt 3 о «размере или качестве»
    бизнеса — в том числе критерий 12 средних зарплат. Это исключение из
    spec-ustawy сохранено и после её сворачивания 5 марта 2026 года
    ([коммуникат Мазовецкого воеводского ужонда][22]).
...
* Документы должны быть переведены у присяжного переводчика (tłumacz przysięgły). Список всех переводчиков Польши
  доступен в [реестре присяжных переводчиков Минюста][5].
...
* Opłata skarbowa - пошлина за выдачу решения (в данном случае – 340 zł) - оплачиваем и распечатываем подтверждение оплаты (на польском).
  Для заявлений, поданных начиная с 5 марта 2026 года, пошлина **не возвращается**
  при отказе или прекращении производства ([сообщение UdSC][23]).
...
!!! note
    ...
    Можно скачать [гайд по написанию бизнес-плана (PDF)][11].
...
* Oświadczenie ob utrzymaniu. Можно скачать [бланк oświadczenie (DOC)](karta-pobytu-docs/oswiadczenie-utrzymanie.doc)
* Załącznik #1.

    Не обязателен для ИП (в Кракове и Варшаве точно не нужен), но могут попросить в других воеводствах.
    Заполните сами на себя. Есть [пример заполнения с информацией][14]. [Пустой бланк в pdf][15].

### 3. Подтверждение 3 ключевых пунктов пребывания

#### 3.1. Медицинское Страхование

Согласно [закону о государственном медицинском страховании (art. 66, ust. 1, pkt. 1, lit. с)](https://sip.lex.pl/akty-prawne/dzu-dziennik-ustaw/swiadczenia-opieki-zdrowotnej-finansowane-ze-srodkow-17127716/art-66), если вы ведете деятельность JDG, вы обязаны оплачивать мед. страховку — за исключением случая, когда деятельность JDG приостановлена (zawieszona).

При регистрации JDG система автоматически отправит ZUS ZUA/ZZA в ZUS для регистрации, т.е. вы имеете мед. страхование.
Проверьте на портале ZUS.pl в разделе высланных документов высланные декларации ZUA (мед.страхование + соц.страхование) или ZZA (только мед.страхование, в случае Ulga na start).

Если у вас есть члены семьи, которые не имеют своей мед.страховки, вы можете прикрепить их к своей мед.страховке, выслав декларацию ZCNA — тем самым у членов семьи так же будет мед.страховка и условие для легализации будет выполнено.

Расшифровка деклараций:

* ZUA – Zgłoszenie do ubezpieczeń/zgłoszenie zmiany danych osoby ubezpieczonej - т.е., в частности, регистрация на мед.страхование и соц.страхование.
* ZCNA - Zgłoszenie danych o członkach rodziny dla celów ubezpieczenia zdrowotnego - регистрация членов семьи для мед.страхования.
* DRA - Deklaracja rozliczeniowa - декларация, которую подают каждый месяц, на базе которой ZUS рассчитывает взносы за месяц.
* ZZA – Zgłoszenie do ubezpieczenia zdrowotnego/zgłoszenie zmiany danych - то же самое, что и ZUA, но без соц.страхования. Применимо в случаях пользования Ulga na start, когда соц.страхование не применимо.
* ZWUA – Wyrejestrowanie z ubezpieczeń - снятие с регистрации ZUA. Используется в случае завершения деятельности JDG. Или в случае смены кода регистрации в ZUS. Например, когда снимаетесь с "тарифа" ZUS Preferencyjny и переходите на ZUS Pełny, заполняете ZWUA и следом ZUA на регистрацию с новым кодом.
* RCA - Imienny raport miesięczny o należnych składkach i wypłaconych świadczeniach - подается за работников, которых вы устроили к себе на работу.
...
#### 3.3. Наличие достаточных средств для проживания
  ...
  (критерии дохода установлены [rozporządzeniem Rady Ministrów][21]
  и пересматриваются раз в три года, следующий пересмотр — к 2028 году).
...
* Opłata skarbowa – пошлина за выдачу решения (в данном случае – 340 zł;
  с 5 марта 2026 года при отказе не возвращается).
...
[22]: https://migrant.wsc.mazowieckie.pl/pl/komunikaty/zmiany-w-szczegolnych-zasadach-dotyczacych-legalnosci-pobytu-obywateli-ukrainy-na
[23]: https://www.gov.pl/web/udsc/brak-zwrotu-oplaty-skarbowej-w-przypadku-odmowy-udzielenia-zezwolenia-pobytowego-odmowy-zmiany-zezwolenia-na-pobyt-czasowy-i-prace-odmowy-przedluzenia-wizy-lub-odmowy-wydania-wizy-schengen-na-granicy-i-w-przypadku-umorzenia-postepowania-w-takiej-sprawie

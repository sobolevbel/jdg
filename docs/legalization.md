...
* Справка об отсутствии задолженности в оплате налогов. Заказать на [biznes.gov.pl](https://www.biznes.gov.pl/pl/opisy-procedur/-/proc/751), платно
...
* Свидетельство о рождении (для детей) / свидетельство о браке (для супруги).
    ...
    Документы, подтверждающие родство, должны иметь апостиль, который тоже должен
    иметь перевод, или быть представленным в польской версии (после процедуры
    umiejscowienia).

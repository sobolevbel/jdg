...
### 1. Базовый пакет 
Базовый пакет – это пакет документов, который нужно предоставить, чтобы ваше заявление приняли и начали рассматривать. Если что-то из 
списка ниже не будет предоставлено – ваше заявление оставят без рассмотрения.

* Wniosek o pobyt czasowy (заявление). *Обычно нужны 2 копии
* Фотографии 4 шт (3,5x4,5, стандартное фото на документы)
* Копия всех заполненных страниц паспорта (если на развороте есть отметки, печати, наклейки виз, информация – делаем копию, если 
  разворот пустой – можно пропустить.
...
* Документы, подтверждающие факт ведения хоз.деятельности – выберите доступное для вашего бизнеса. Также другие документы, которые 
  подтверждают факты из анкеты / бизнес-плана / заявления.
...
* Контракты з клиентами (+ доверенный перевод если контракт не содержит польской версии)
...
* Подтверждения оплаты ZUS и налогов
* Справка о незадолженности в ZUS. [Инструкция как получить справку.](zus.md#zus_1)
* Справка об отсутствии задолженности в оплате налогов. [Инструкция как получить справку.](taxes.md#zus_1)
...
* Zalącznik #1 – вообще он не обязателен для ИП, но могут настоятельно
попросить. Заполните сами на себя. Пример заполнения и информации по [линку][4].
Пустой бланк в [pdf][5].
...
* Свидетельство о рождении (для детей) / свидетельство о браке (для супруги).
    ...
    Документы, подтверждающие родство (свидетельство о браке/свидетельство о рождении и т.п.) должны быть переведены присяжным переводчиком. Однако, поскольку могут быть разночтения в разных воеводствах, перед подачей проверте требования на сайте ужонда.
...
- При подаче документов на карту побыта нужны и копии и оригиналы следующих документов: песель, мельдунек, договор аренды. Копии отдадите, а оригиналы нужны только, чтобы смогли заверить копии. Поэтому приносите копии и оригиналы, отдаёте только копии.

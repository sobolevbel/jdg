...
2. Нужно заработать мин зарплату годовую (около 65 000 злотых). Имеется ввиду зарплата бруто, то есть, с которой платится подоходный налог.
...
* Документы, потверждающие факт ведения хоз.деятельности – выберите доступное для вашего бизнеса. Также другие документы, которые подтверждают факты из анкеты/бизнес- плана/заявления
...
* ZUS ZCNA + ZUS ZUA/ ZUS ZLL + ZUS RCA/DRA основного заявителя. 
  ...
  Если вы зарегистрированы в зус, все эти документы у вас уже есть
...
### 3. Подтвержление трех ключевых пунктов пребывания

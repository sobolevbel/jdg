...
Согласно [закону о государственном медицинском страховании (art. 66, ust. 1, pkt. 1, lit. с)](https://sip.lex.pl/akty-prawne/dzu-dziennik-ustaw/swiadczenia-opieki-zdrowotnej-finansowane-ze-srodkow-17127716/art-66), если Вы ведете JDG деятельность, вы обязаны оплачивать мед. страховку, за исключением, если JDG  не завешона.

При регистрации JDG система автоматически отправит ZUS ZUA/ZZA в ZUS для регистрации, т.е. вы имеете мед. страховкание.
...
Если у вас есть челены семьи, которые не имеют своей мед.страховки, Вы можете прикрепить их к своей мед.страховке, выслав декларацию ZCNA, тем самым у челенов семьи так же будет мед.страховка и условие для легализации будет выполнено.
...
* ZCNA - Zgłoszenie danych o członkach rodziny dla celów ubezpieczenia zdrowotnego - регистрация челенов семьи для мед.страхование.
* DRA - Deklaracja rozliczeniowa - декларация, которую подают каждый месяц, на базе которой ZUS расчитывает взносы за месяц.
* ZZA – Zgłoszenie do ubezpieczenia zdrowotnego/zgłoszenie zmiany danych - Тоже самое, что и ZUA, но без соц.страхования. Применимо в случаях пользования Ulga na start, когда соц.страхование не применимо.
* ZWUA – Wyrejestrowanie z ubezpieczeń - снятие с регистрации ZUA. Используется в случае завешения деятельности JDG. Или в случае смены кода регистрации в ZUS. Например, когда снимаетесь с "тарифа" ZUS Preferencyjny и переходите на ZUS Pełny, заполняете ZWUA и следом ZUA на регистрацию с новым кодом.
...
Согласно [закону о иностранцах (art. 142, ust. 1, pkt. 1, lit. a)](https://sip.lex.pl/akty-prawne/dzu-dziennik-ustaw/cudzoziemcy-18053962/art-142), одним из условий получения зезволения на пребывание является наличие у иностранца медицинской страховки.

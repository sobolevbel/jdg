...
ZUS состоит из 2 основных частей: медицинский (składka zdrowotna) и социальный (включает себя пенсионный, по утрате трудоспособности, фонд больничного (добровольный), фонд труда и т.д.)

Размер медицинской складки ZUS в месяц, рассчитывается в зависимости
от годового прихода. При превышении порога, пересчет идет и за прошлые
месяцы.

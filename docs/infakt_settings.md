...
![inFakt: страница Ustawienia с данными фирмы][2]

Впишите свой номер NIP и подтянутся сведения о вашем ИП из картотеки

![inFakt: поле NIP для автозагрузки данных фирмы][3]
...
Для активации бухгалтерии откройте закладку [Księgowość][4] на главном экране. Проверьте свои данные и подтвердите номер телефона. Затем выберите из списка советника/консультанта из своего региона.
...
![inFakt: активация бухгалтерии — регистрационные данные, PESEL, система налогообложения][5]
...
![inFakt: настройки Składki ZUS — ulga na start, składka zdrowotna][10]
...
![inFakt: поле Indywidualny rachunek składkowy][12]
...
![inFakt: форма Nowy Produkt — Nazwa, Cena netto, ставки VAT и Ryczałt][15]
...
![inFakt: форма Nowy Klient с поиском по NIP][17]
...
![inFakt: Ustawienia → Faktury → Konta bankowe, добавление счёта][19]
...
![inFakt: Ustawienia → Faktury → Szablony — подпись и логотип][21]

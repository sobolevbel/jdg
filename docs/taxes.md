...
Сгенерировать счет для оплаты подоходного налога можно:

- на сайте [налоговой][1] на основе своего идентификатора NIP.
- на сайте Urządu Skarbowego [в разделе отчетов налогоплательщика](https://urzadskarbowy.gov.pl/taxpayer-report) (искать Mikrorachunek podatkowy), кроме того тут же можно и проверить оплату налогов на странице https://urzadskarbowy.gov.pl/balances-and-settlements (данные появляются через несколько дней после оплаты)

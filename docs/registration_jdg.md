...
!!! success "Регистрация — только начало"
    Дальше вас ждут фактуры, взносы ZUS и декларации каждый месяц.
    Разобраться самостоятельно поможет [рабочий процесс](workflow.md),
    а если хочется делегировать — есть русскоязычный
    [бухгалтер под ключ](accounting.md) от партнёра гайда.

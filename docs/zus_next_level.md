...
Для начала залогиньтесь в eZUS как описано [здесь][3].
...
![ePłatnik, Dokumenty wysłane: документ ZUS ZZA и кнопка Podgląd poświadczenia przedłożenia][5]
...
Если в процессе столкнётесь с проблемой, то в первую очередь загляните в наш [сборник ошибок][6].
...
[5]: images/zus_next_level/ZUS_ZZA_UPP.jpg
[6]: zus_errors.md

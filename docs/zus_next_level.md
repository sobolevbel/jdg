...
📅 Используйте нашу [табличку с важными датами][1]. Введите правильную дату начала деятельности и получите персонализированный расчёт бесплатно! Затем создайте напоминания в своём календаре, чтобы не пропустить эти важные даты.
...
!!! success "Официальный сайт"
    Все коды можно найти в [поисковике описания профессий][2] (Wyszukiwarka opisów zawodów).
...
Для начала залогиньтесь в eZUS, как описано в [инструкции по входу в eZUS][3].
...
UPP = Urzędowe Poświadczenie Przedłożenia — подтверждение подачи декларации в ZUS, которое генерирует zus.pl. Без UPP нельзя подтвердить подлинность распечатанных форм ZUS ZUA и ZUS ZZA.

В целях подтверждения наличия страховки в ZUS рекомендуется использовать справку Potwierdzenie ubezpieczenia. Подробнее читайте в [чеклисте документов для ВНЖ][4].
...
Если в процессе столкнётесь с проблемой, то в первую очередь загляните в наш [сборник ошибок][5].
...
[1]: https://docs.google.com/spreadsheets/d/1UGRsxqBA7DoO3wNmzuvD8TxAsqiIv_jhyw38wQfaH10/edit
[2]: https://psz.praca.gov.pl/rynek-pracy/bazy-danych/klasyfikacja-zawodow-i-specjalnosci/wyszukiwarka-opisow-zawodow
[3]: zus_login.md
[4]: https://justandrei.github.io/jdg-tools/checklist/#c-zus-insurance-confirmation
[5]: zus_errors.md

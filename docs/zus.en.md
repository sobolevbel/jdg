...
2026 numbers, amounts in złoty per month, ryczałt taxation
(only the składka zdrowotna depends on the taxation form).

**Składki społeczne and Fundusz Pracy** depend on the ZUS payment mode:

| Contribution | Ulga na start | Składki preferencyjne | Duży ZUS |
|---|---:|---:|---:|
| Emerytalna | — | 281.44 | 1,103.27 |
| Rentowa | — | 115.34 | 452.16 |
| Wypadkowa | — | 24.08 | 94.39 |
| Fundusz Pracy | — | — | 138.47 |
| **Mandatory total** | **0** | **420.86** | **1,788.29** |

**Składka zdrowotna** is the same in every mode and depends on annual income:

| Annual income | Składka zdrowotna |
|---|---:|
| up to 60,000 | 498.35 |
| 60,000 — 300,000 | 830.58 |
| above 300,000 | 1,495.04 |

**Total per month** (społeczne + Fundusz Pracy + zdrowotna):

| Annual income | Ulga na start | Składki preferencyjne | Duży ZUS |
|---|---:|---:|---:|
| up to 60,000 | 498.35 | 919.21 | 2,286.64 |
| 60,000 — 300,000 | 830.58 | 1,251.44 | 2,618.87 |
| above 300,000 | 1,495.04 | 1,915.90 | 3,283.33 |

On top of that you may pay the voluntary składka chorobowa —
[sick leave and maternity](zus_chorobowe.md): **+35.32** on Preferencyjne
and **+138.47** on Duży ZUS. It cannot be joined while on Ulga na Start.

...
2. При отправке декларации за предыдущий месяц (последний месяц ульги на старт), скорее всего при верификации
декларации вы увидите статус Informacja, и в списке ошибок текст

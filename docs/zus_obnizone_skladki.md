...
По возможности подайте декларацию ZUS DRA за последний месяц ульги на старт до того, как начнёте процесс перехода. Либо просто не обращайте внимание на то, что при подаче декларации уже после перехода ZUS будет "ругаться" на несовпадение кода в декларации с кодом в реестре – это не ошибка, а просто предупреждение.

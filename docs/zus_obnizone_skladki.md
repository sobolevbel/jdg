...
2. Зарегистрироваться для страхования:
	...
	- Если работаете параллельно на Umowa o Pracę, то с помощью бланка **ZUS ZZA**;
	
	- Иначе с помощью бланка **ZUS ZUA** ([подробнее](https://sobolevbel.github.io/jdg/zus_obnizone_skladki/#2-registratsiia-zus-zua-s-kodom-05-70)) с новым кодом 0570 xx.

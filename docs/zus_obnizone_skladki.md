...
После 6 полных месяцев использования **Ulga na start** можно воспользоваться возможностью уплаты пониженных взносов ZUS (льгота "Obniżone składki", также известная как **Składki preferencyjne**) в течение 24 полных месяцев.

## Когда переходить на składki preferencyjne

Льгота  **Składki preferencyjne** начинает действовать всегда с первого числа месяца. На подачу обоих документов даётся 7 дней.

Таким образом, начинать переход нужно не раньше первого числа месяца, за который уже планируете платить składki preferencyjne, но и не затягивать с этим, чтобы завершить до 8-го числа.
...
Изменять настройки в inFakt/iFirma/wFirma рекомендуется после того, как отправить перечисленные выше документы.
...
Исключение: если вы работаете по Umowa o Pracę или получаете пенсию параллельно с JDG, и на предыдущем этапе правильно подали ZUS ZZA, то вы освобождены от уплаты взносов składki spoleczne (за себя как JDG), поэтому нужно выбрать "Tylko zdrowotne — 2-letni preferencyjny ZUS".

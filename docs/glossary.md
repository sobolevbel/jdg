---
title: Словарь терминов JDG
description: Словарь сокращений и польских терминов для ИП — JDG, ZUS, VAT, PIT, NIP, REGON, ryczałt, skala podatkowa, składki и другие
tags:
  - Справочник
  - JDG
---
...
- EMP - внесек в ZUS о назначении [пенсии][11]
- IKE - Indywidualne Konto Emerytalne - индивидуальный пенсионный счёт: выплата после
  60 лет не облагается налогами. Подробнее — на странице [«Пенсия»][11]
- IKZE - Indywidualne Konto Zabezpieczenia Emerytalnego - индивидуальный счёт пенсионного
  обеспечения: взносы вычитаются из базы PIT, у JDG повышенный годовой лимит
...
- OFE - Otwarty Fundusz Emerytalny - открытый пенсионный фонд: в него может идти часть
  пенсионного взноса; средства в OFE наследуются
...
- e-ZLA - elektroniczne zwolnienie lekarskie - электронный больничный: врач отправляет его
  в ZUS автоматически
...
- emerytura - пенсия. Как она считается и как её увеличить — на странице [«Пенсия»][11]
- faktura - invoice - счёт-фактура
- forma opodatkowania - форма налогообложения
- kantor - обменник валют
- kapitał początkowy - «начальный капитал»: пенсионные взносы за работу в Польше
  до 1999 года, добавляются к пенсионному счёту в ZUS
- konto firmowe - бизнес-счёт, фирменный счёт
- koszty prowadzenia działalności - расходы на ведение бизнеса
- księgowy - бухгалтер
- likwidacja - ликвидация
- najem  - аренда
- okres wyczekiwania - период ожидания: минимальный срок непрерывного страхования,
  после которого возникает право на пособие (для больничного — 90 дней)
- okresy składkowe i nieskładkowe - периоды со страховыми взносами и без них;
  вместе образуют страховой стаж (nieskładkowe считаются максимум как 1/3 składkowych)
- podatek - налог
...
- składka chorobowa - добровольный взнос на страхование на случай болезни: даёт право
  на больничные и декретные. Подробнее — на странице [«Больничные и декрет»][12]
- składka zdrowotna - взнос на медстрахование
- składki spoleczne - взнос на соцстрахование
- subkonto - субсчёт в ZUS, куда идёт часть пенсионного взноса; в отличие
  от основного счёта, средства subkonta наследуются
- środek trwały - актив
- świadczenie rehabilitacyjne - реабилитационное пособие: продление выплат после
  исчерпания больничного (до 12 месяцев)
- ulga - льгота
- waloryzacja - индексация: ежегодное повышение пенсионного капитала, пенсий и пособий
- wirtualne biuro - виртуальный офис
- zasiłek chorobowy - пособие по болезни (больничные)
- zasiłek macierzyński - пособие по материнству (декретные)
- zasiłek opiekuńczy - пособие по уходу за больным ребёнком или членом семьи

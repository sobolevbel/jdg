...
6. [Отправка декларации VAT-UE][38]
...
4. услугу
5. количество "услуги" (если почасовая, то кол-во отработанных часов, если фиксированная ставка, то оставляем 1, так как сумма нетто уже есть ставка), а также вашу процентную ставку Ryczałt и VAT.
...
(TODO: нужно актуализировать по VAT)

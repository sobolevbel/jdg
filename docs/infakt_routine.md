...
![Jednolity Plik Kontrolny — список деклараций][38]
...
![Podatek VAT-UE — список деклараций][39]
...
2. Отредактировать неверную фактуру. Для этого из списка фактур (таба **Przychody** / **Lista przychodów**) зайти непосредственно на страницу фактуры, которую вам необходимо отредактировать, далее в правом верхнем углу нажать на кнопку `...` и далее на кнопку **Edytuj** ![][33]

Отредактируйте вашу фактуру, и нажмите кнопку **Zapisz** в нижнем правом углу. ![][34]
...
[27]: images/infakt_routine/jpk_vat/jpk_vat1.png
...
[35]: images/infakt_routine/ksiegowosc_przeglad.png
[36]: https://www.podatki.gov.pl/generator-mikrorachunku-podatkowego
[37]: https://www.infakt.pl/blog/jak-rozliczyc-roznice-kursowe-na-ryczalcie/
[38]: images/infakt_routine/jpk_vat/jpk_v7_list.png
[39]: images/infakt_routine/podatek_vat_ue.png
[40]: images/infakt_settings/ustawienia_przychod_w_roku.png

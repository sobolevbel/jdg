...
Минимальная настройка infakt описана на [странице настройки infakt][1].
...
![inFakt: форма новой фактуры — заказчик, даты, услуга, ставка VAT][6]
...
![inFakt: список фактур, пункт Pobierz PDF с выбором языка][7]
...
Узнать свой счет для уплаты налогов можно по [инструкции на странице о налогах][8].
...
![inFakt: налог к оплате, кнопка Opłać z inFakt][10]
...
!!! example "На примере Millenium (сайт банка)"
    ...
    ![Millenium: меню Płatności, пункт Podatkowy/Celny](images/infakt_routine/podatek_millenium_1.png)
...
![PKO: форма Przelew Podatkowy — Pozostałe, symbol PPE, налоговый счёт, Okres, NIP][11]

## Составление декларации ZUS DRA и оплата взносов

Номер своего микро счета ZUS можно узнать на [eskladka.pl][12].
Настройка ZUS в inFakt описана в [разделе настройки данных ZUS][13].
...
![PKO: перевод складки ZUS — получатель, номер микросчёта, Tytuł][14]
...
![inFakt: список складок ZUS, ссылка Przejdź do składki][15]
...
![inFakt: страница складки — кнопки Dodaj załącznik и Pobierz ZUS DRA][16]
...
![Портал ZUS, ePłatnik: раздел Dokumenty, пункт Import KEDU][18]
...
![ePłatnik, Import KEDU: экран Wybór dokumentów, кнопка Dalej][19]

![ePłatnik, Import KEDU: кнопка Wybierz plik и загруженный xml-файл][20]

Если после импорта файла появится декларация ZIPA, то снимаем с нее галочку и жмем Dalej.

![ePłatnik, Import KEDU: снятие галочки с декларации ZUS ZIPA][21]
...
![inFakt: список фактур, меню с пунктом Dowód wewnętrzny][25]
...
![inFakt: форма Dowód wewnętrzny — Pozostałe przychody, сумма курсовой разницы][26]
...
2. Отредактировать неверную фактуру. Для этого из списка фактур (таба **Przychody** / **Lista przychodów**) зайти непосредственно на страницу фактуры, которую вам необходимо отредактировать, далее в правом верхнем углу нажать на кнопку `...` и далее на кнопку **Edytuj** ![inFakt: кнопка Edytuj в меню фактуры][35]

Отредактируйте вашу фактуру, и нажмите кнопку **Zapisz** в нижнем правом углу. ![inFakt: кнопка Zapisz][36]
...
[27]: images/infakt_routine/jpk_v7_list.png
[28]: images/infakt_routine/jpk_03_zwrot_vat.jpg
[29]: https://sip.lex.pl/akty-prawne/dzu-dziennik-ustaw/podatek-od-towarow-i-uslug-17086198/art-87
[30]: images/infakt_routine/jpk_04_zaliczenie.png
[31]: images/infakt_routine/jpk_02_wyslij.jpg

...
Если после выставления фактуры была обнаружена ошибка (например неверная сумма инвойса вне зависимости сумма отличается в меньшую либо большую сторону) **и за данный месяц ещё не были оплачены налоги и сформирована декларация ZUS DRA** существует несколько вариантов исправления данной ошибки:

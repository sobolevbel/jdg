...
### Оплата налогов через банковское приложение PKO
...
### Оплата налогов через сайт Millenium

Переходим Płatności > Podatkowy/Celny
...
3) [Номер счета для уплаты налогов][36]
4) Ваш NIP
5) Выбрать Okres - Miesiąc и соответственное год и месяц за который платится налог
6) Сумма платежа
7) Комментарий к платежу (необязательное поле). Я обычно пишу "Тип платежа за месяц года" т.е. PPE za październik 2024

Внизу нажать DALEJ и подтвердить платеж
...
❗️Если у вас выбран план подписки Premium в Infakt, курсовые разницы будут учтены автоматически при отметке фактуры
как оплаченной. Если вы используете более дешевые планы подписки, вы можете воспользоваться следующей инструкцией.

...
*(Подразумевается что вы знаете номер своего налогового счета. См [тут](taxes.md). Infakt получает номер счета автоматически при насттройке)*
 ...
 *(Подразумевается что вы знаете номер своего миктосчета ZUS. См детали как настроить [тут](infakt_settings.md))*

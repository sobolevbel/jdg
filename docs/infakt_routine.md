...
последний рабочий день, предшествующий дате поступления оплаты. Если валюта с фирмового счета продается позже, то в
...
[29]: infakt_routine.md#выставление-фактур
[30]: infakt_routine.md#оплата-налогов
[31]: infakt_routine.md#составление-декларации-zus-dra-и-оплата-взносов
[32]: infakt_routine.md#получение-оплаты-и-учет-курсовых-разниц
[33]: infakt_routine.md#отправка-декларации-vat-jpk_v7m
[34]: https://eskladka.pl/Home
[35]: infakt_settings.md#настройка-данных-zus
[36]: taxes.md#как-узнать-свой-счет-для-оплаты-налогов

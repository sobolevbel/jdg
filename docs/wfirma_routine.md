...
3. Если сумма соответствует вашим ожиданиям, то нажимаем Zapłać для оплаты. Срок оплаты: до 20 числа месяца, следующего за отчётным. На скриншоте получился **ZUS = 461.66 zł**. Ровно столько выходит к оплате в ZUS первый платёж для предпринимателей на рычалте, которые используют льготу Ulga na Start, в 2025 году.

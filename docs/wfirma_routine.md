...
9. Если экспортируете услугу для юрлица (компании) с офисом в ЕС или за пределами ЕС (т.е. не в Польшу и не физлицу), то в Opis напишите:
...
1. Schemat księgowy - Выберите схему бухгалтерского учёта, которая зависит от того, кому и в какую страну вы предоставляете услугу.
    ...
    Например, нужно выбрать "Świadczenie usług w UE", если экспортируете услугу юрлицу (компании) с офисом в ЕС. В таком случае wFirma сама добавит "Odwrotne obciążenie / Reverse charge" в печатную версию фактуры (перепроверяйте):
...
Чтобы отправить декларацию ZUS DRA из wfirma, сначала необходимо [верифицировать профиль][31]. Далее:

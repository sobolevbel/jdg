...
- Аудит цифр гайда: все суммы и лимиты на 2026 год сверены с официальными источниками (ZUS, GUS, podatki.gov.pl) — расхождений нет. На странице [легализации](legalization.md) отражены изменения от 5 марта 2026 года: opłata skarbowa (340 zł) больше не возвращается при отказе, а к гражданам Украины с PESEL UKR не применяется критерий 12 средних зарплат.
- Починены нерабочие ссылки: переходы на [Ulga na start](zus_ulga_na_start.md) и на [ежемесячные отчёты во время ZUS-каникул](zus_vacation.md#ezhemesiachnye-otchety-vo-vremia-zus-kanikul) открывали страницу сверху вместо нужного раздела, а старые английские адреса `/en/registration/` и `/en/legalization_warsaw/` вели на несуществующую страницу вместо новой. Страница «не найдено» снова на русском языке.
- Гайд переехал на собственный домен — `twojajdg.pl`. Старые адреса вида `sobolevbel.github.io/jdg/…` перенаправляются на новые автоматически, так что закладки и ссылки из чатов продолжают работать.
- Актуализирован шаг [регистрации VAT-UE в CEIDG](registration_vat_ue.md#13-registratsiia-platelshchikom-vat-ue): чек-боксы товаров/услуг убраны из формы, теперь указывается только предполагаемая дата начала внутрисоюзных транзакций (обновлён скриншот).
- Новая страница: [«Бухгалтер под ключ»](accounting.md) — когда стоит делегировать бухгалтерию, условия партнёра гайда Legal Tax Level и честный раздел об альтернативах.
- Страница [Profil Zaufany](pz.md) дополнена: зачем он нужен, как войти (в том числе если профиль создан через банк и пароля нет), как восстановить пароль и продлить срок действия.

## Июль 2026

- Ревизия контента: актуализирован минимальный доход для карты побыту ([823 zł на члена семьи / 1010 zł для одиночки](legalization.md#3-podtverzhdenie-3-kliuchevykh-punktov-prebyvaniia) на 2026 год, было указано 600 zł от 2022 года), убраны устаревшие суммы и годы 2022–2025 на страницах ZUS, налогов и бухгалтерии, чек-лист [легализации семьи](legalization.md) больше не дублирует чек-лист предпринимателя.
